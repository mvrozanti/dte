...
`n - 1234` returns `18974 days, 2:29:36.329325`

`10h30 + 14h` returns `1 day, 0:30:00`

`2021 feb 14 12:00:00` returns `2021-02-14 12:00:00`

`seconds until 2021 feb 14 12:00:00` returns `-26049010.57`
...
`1957-12-26 - t` returns `-23362 days, 0:00:00`

`1957-12-26 22:22:22 - t` returns `-23362 days, 22:22:22`
...
`T-1.5d` returns `2021-12-10 12:00:00`

`T-10d` returns `2021-12-02`
...
`n` returns `2021-12-12 23:50:15.699707`

`next Sunday` returns `2021-12-19`

`2000-10-10 00:16` returns `2000-10-10 00:16:00`

`2000-10-10 16:00` returns `2000-10-10 16:00:00`

`seconds until 3000 Apr 10` returns `30872880583.98`

`seconds since 3000 Apr 10` returns `-30872880583.89`
...
`yd-5h` returns `2021-12-10 19:00:00`
...
`seconds until tomorrow` returns `581.85`

`seconds until 11 pm` returns `83381.77`
...
`days until 2030-12-25` returns `3299.01`
...
`monday+1d` returns `2021-12-14`

`next mon + 1d` returns `2021-12-14`

`days until next mon` returns `0.01`

`days until mon` returns `0.01`
...
`t 1am` returns `2021-12-12 01:00:00`

`t 1:00` returns `2021-12-12 01:00:00`

`t 1:00 == t 1am` returns `True`

`(2020-10-10+1d) 3pm` returns `2020-10-11 15:00:00`

`1am t` returns `2021-12-12 01:00:00`

`1am t == t 1am` returns `True`

`t+1d 08h30` returns `2021-12-13 08:30:00`

`april+1M` returns `2022-05-01`

`last sun in 2021` returns `2021-12-26`

`days until Jan 2030` returns `2941.01`
